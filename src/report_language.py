...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "ma5_comparison_heading": "多股价格与 MA5 一览",
        "stock_code_column_label": "代码",
        "name_column_label": "名称",
    ...
    "en": {
        ...
        "ma5_comparison_heading": "Multi-stock price vs MA5",
        "stock_code_column_label": "Ticker",
